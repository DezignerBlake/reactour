...
var Tour = (_a) => {
  ...
  const TourWrapper = Wrapper ? Wrapper : import_react8.default.Fragment;
  return step ? /* @__PURE__ */ import_react8.default.createElement(TourWrapper, null, /* @__PURE__ */ import_react8.default.createElement(
    import_utils3.Observables,
    {
  ...
  ), (!disableWhenSelectorFalsy || target) && /* @__PURE__ */ import_react8.default.createElement(
    Mask_default,
    {
    ...
    ContentComponent ? /* @__PURE__ */ import_react8.default.createElement(
      ContentComponent,
      __spreadValues({
        styles,
        setCurrentStep,
...
var TourProvider = (_a) => {
  ...
  return /* @__PURE__ */ import_react9.default.createElement(TourContext.Provider, { value }, children, isOpen ? /* @__PURE__ */ import_react9.default.createElement(Tour_default, __spreadValues({}, value)) : null);
};
...
function withTour(WrappedComponent) {
  const ComponentWithTour = (props) => {
    ...
    return /* @__PURE__ */ import_react10.default.createElement(WrappedComponent, __spreadValues(__spreadValues({}, props), tourProps));
  };
